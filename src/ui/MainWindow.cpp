...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent){
    ...
    QSettings settings;
    constantFolderPath = settings.value("defaultFolder", QDir::homePath()).toString();
...
void MainWindow::setupConnections() {
    ...
    connect(leftWidget, &LeftWidget::openFolderRequested, this, &MainWindow::openFolderDialog);
    connect(leftWidget, &LeftWidget::constantFolderRequested, this, &MainWindow::openConstantFolder);

    // Connect BottomWidget signals
    connect(bottomWidget, &BottomWidget::playPauseClicked, this, &MainWindow::togglePlayback);
    connect(bottomWidget, &BottomWidget::volumeMuteClicked, this, &MainWindow::toggleMute);
    connect(bottomWidget, &BottomWidget::nextClicked, this, &MainWindow::playNextTrack);
    connect(bottomWidget, &BottomWidget::previousClicked, this, &MainWindow::playPreviousTrack);
    ...
    QShortcut *skipForwardShortcut = new QShortcut(QKeySequence(Qt::Key_Right), this);
    connect(skipForwardShortcut, &QShortcut::activated, this, &MainWindow::skipForward);

    QShortcut *skipBackwardShortcut = new QShortcut(QKeySequence(Qt::Key_Left), this);
    connect(skipBackwardShortcut, &QShortcut::activated, this, &MainWindow::skipBackward);
...
void MainWindow::openConstantFolder() {
    ...
    if (!folderPath.isEmpty()) {
        ...
        rightWidget->setTreeRootPath(constantFolderPath); // This will update both views to match the saved path
    }
}
...
void MainWindow::loadListDirectory(const QString &folderPath, bool resetPlayback) {
...
bool MainWindow::eventFilter(QObject *watched, QEvent *event) {
    if (event->type() == QEvent::KeyPress) {
        ...
        const bool isCtrlPressed = keyEvent->modifiers().testFlag(Qt::ControlModifier);
